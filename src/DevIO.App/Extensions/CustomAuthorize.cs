...
namespace DevIO.App.Extensions
{
    ...
    {
        public ClaimsAuthorizeAttribute(string claimName, string cliamValue): base(typeof(RequisitoClaimFilter))
        {
            Arguments = new object[] { new Claim(claimName, cliamValue) };
